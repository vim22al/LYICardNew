...
export class AdminDashboardController {
  ...
  public getGrowthData = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
      const thirtyDaysAgo = new Date(Date.now() - 30 * 24 * 60 * 60 * 1000);
  ...
  public getActivityFeed = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
  ...
  public getTopUsers = async (req: AuthRequest, res: Response): Promise<void> => {
    try {
