...
const getTransporter = async () => {
    ...
    const configMap = dbConfigs.reduce((acc, curr) => {
...
export const sendEmail = async ({ to, subject, html, attachments = [], }) => {
    try {
        ...
        const user = transporter?.options && 'auth' in transporter.options && transporter.options.auth.user ? transporter.options.auth.user : 'noreply@lyicard.example.com';
